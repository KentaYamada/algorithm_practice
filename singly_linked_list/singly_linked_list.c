...
SinglyLinkedList* singly_linked_list_create_cell() {
    SinglyLinkedList* cell = (SinglyLinkedList*)malloc(sizeof(struct singly_linked_list_t));
    cell->next = NULL;
    cell->value = 0;
...
void singly_linked_list_insert_cell(SinglyLinkedList* header, SinglyLinkedList* cell, const int index) {
    if (index == 0) {
